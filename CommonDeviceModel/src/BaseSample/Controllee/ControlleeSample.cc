...
const CdmInterfaceType ControlleeSample::RegisterVendorDefinedInterface(const qcc::String& interfaceName, CreateIntfControlleeFptr createIntfControllee)
{
    return m_controllee->RegisterVendorDefinedInterface(interfaceName, createIntfControllee);
}
