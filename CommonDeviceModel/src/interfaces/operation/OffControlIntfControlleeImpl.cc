...
QStatus OffControlIntfControlleeImpl::Init()
{
    ...
    //
    // Add by hand the handler of the SwitchOff method to the vector MethodHandlers.
    //
...
QStatus OffControlIntfControlleeImpl::OnGetProperty(const String& propName, MsgArg& val)
{
    ...
    if (!(s_prop_Version.compare(propName))) {
        ...
        //
        // Add by hand the return value of ER_BUS_NO_SUCH_PROPERTY for getting other properties 
        // since this interface has only one property "Version".
        //
...
QStatus OffControlIntfControlleeImpl::OnSetProperty(const String& propName, MsgArg& val)
{
    ...
    //
    // Add by hand the return value of ER_BUS_NO_SUCH_PROPERTY for setting the properties 
    // since this interface doesn't have any writtable property.
    //
    status = ER_BUS_NO_SUCH_PROPERTY;
